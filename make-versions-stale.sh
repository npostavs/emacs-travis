...
# If curl complains about tls certificates: from Firefox, open
# github.com and export the certificate with chain (PEM) to this file.
if [ -r githubcom.crt ] ; then
    export CURL_CA_BUNDLE=githubcom.crt
fi
